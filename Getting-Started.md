...
::::AVITAL TODO:::: Please a one paragraph note here about AppTokens, and when to use KS vs. AppTokens vs. user.loginByLoginId

 
## Uploading Media Files

::::AVITAL TODO:::: let's also discuss the benefits of parallel chunked uploading that is provided by using the libraries (either chunked-file-upload-jquery or kaltura-parallel-upload-resumablejs or Sample-Kaltura-Chunked-Upload-Java), it's not just one library. Consult Jess on what's best to present here or how to best talk about it.
